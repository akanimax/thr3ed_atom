...
@click.option("--num_iterations_per_stage", type=click.INT, required=False, default=7000,
...
@click.option("--lr_decay_steps_per_stage", type=click.INT, required=False, default=3000,
